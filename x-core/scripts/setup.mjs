 ...
 * Initializes .x-build/ in the current working directory
 */
...
const TARGET = join(CWD, '.x-build');

if (existsSync(TARGET)) {
  console.log('✅ .x-build/ already exists in this directory.');
  process.exit(0);
}
...
console.log('✅ .x-build/ initialized.');
