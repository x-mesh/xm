...
<p align="center">
  <a href="https://github.com/x-mesh/xm/releases"><img src="https://img.shields.io/badge/version-2.23.14-blue" alt="Version" /></a>
...
### 프로젝트 간 핸드오프 — toss / inbox

프로젝트 A에서 찾은 재현 사례가 실제로는 프로젝트 B의 문제인 경우가 많습니다. `/xm:toss`는 세션이나 디렉토리를 바꾸지 않고 B에 리포트를 넣고, `/xm:inbox`는 받는 쪽입니다.

```
/xm:toss git-kit "worktree add가 gitignore된 상태를 빠뜨림"   # 등록된 다른 프로젝트로 리포트 전송
/xm:inbox                                                     # 다른 프로젝트가 보낸 항목 확인
```
