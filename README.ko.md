...
<p align="center">
  ...
  <a href="#플러그인"><img src="https://img.shields.io/badge/plugins-13-orange" alt="Plugins" /></a>
</p>
...
- [빠른 시작](#빠른-시작)
- [왜 xm인가?](#왜-xm인가)
- [플러그인](#플러그인) — [x-build](#x-build) · [x-op](#x-op) · [x-review](#x-review) · [x-solver](#x-solver) · [x-probe](#x-probe) · [x-eval](#x-eval) · [x-humble](#x-humble) · [x-agent](#x-agent) · [x-trace](#x-trace) · [x-memory](#x-memory) · [x-dashboard](#x-dashboard) · [x-humanize](#x-humanize) · [x-recall](#x-recall)
