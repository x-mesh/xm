...
2. Filename: `refine-{YYYY-MM-DD}-{slug}.json` (slug from topic, ≤ 40 chars, lowercase, hyphens)
3. Write JSON per the result schema (include `outcome.verdict="adopted"`, `outcome.summary`, `self_score`, `rounds_summary`)
