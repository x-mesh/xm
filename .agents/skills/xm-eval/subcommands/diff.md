...
Measure change volume and quality delta of xm plugins. Git-based quantitative analysis + optional quality comparison. Usage: `/xm:eval diff [--from <commit>] [--to <commit>] [--quality]`.

## Subcommand: diff

**Measure change volume and quality delta of xm plugins. Git-based quantitative analysis + optional quality comparison.**
...
git diff --stat {from}..{to} -- 'x-build/' 'x-op/' 'x-eval/' 'xm/' ...
