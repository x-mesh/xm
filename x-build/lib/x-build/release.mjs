...
const PLUGIN_DIRS = [
  ...
  'x-dashboard', 'x-humanize', 'xm', 'x-sync', 'x-ship', 'x-recall',
];
...
function detectProjectType(cwd) {
  if (existsSync(join(cwd, '.claude-plugin', 'marketplace.json'))) return 'xm-marketplace';
...
export function cmdReleaseBump(args) {
  ...
  // 5. package.json root version = xm version
