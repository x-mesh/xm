...
|------|:-:|:-:|:-:|:-:|:-:|:-:|
| xm SKILL 본문 | ✅ | ✅ `.cursor/rules/*.mdc` | ✅ `plugins/xm/skills/*/SKILL.md` | ✅ `.kiro/steering/*.md` | ✅ `.agent/skills/*.md` (또는 `~/.gemini/antigravity/skills/`) | ✅ `.opencode/skills/*/SKILL.md` (또는 `~/.config/opencode/skills/*/SKILL.md`) |
...
| 명시 호출 디스커버리 | ✅ `/xm:build` | △ `.cursor/commands/` (현재 미정의) | ✅ `/skills` 또는 `$` 자동완성의 `$xm:build` | ❌ | △ workflows 파일 | ❌ skill-only |
