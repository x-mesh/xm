...
✅ Team "{name}" created
  ...
  Assign a goal: /xm:agent team assign {name} "목표"
```
...
🚀 Goal assigned to team "{team}"
  ...
  Check progress: /xm:agent team status {team}
  Request report: /xm:agent team report {team}
```
...
📋 Team Templates
  ...
  Create from template: /xm:agent team create myteam --template engineering
```
