...
/** Run exactly one expensive panel after every task in a group has completed. */
export function reviewBuildGroup(project, tasks, groupId = null, { cwd = repoRoot(), rounds = null } = {}) {
  const policy = loadBuildPolicy();
