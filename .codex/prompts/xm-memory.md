...
All commands via:
```bash
node .codex/xm/lib/x-memory-cli.mjs <command> [args]
```

Shorthand in this document: `$XMM` = `node .codex/xm/lib/x-memory-cli.mjs`
...
>   local cli=".codex/xm:-}/lib/x-memory-cli.mjs"
